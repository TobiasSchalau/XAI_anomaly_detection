...
def test_preprocessing():
    ...
    unique_values = {colname: target.train_data[colname].unique() for colname in categorial_columns}
    ...
    assert all([a == b for a, b in zip(target.train_data.columns, columns_preprocessed)])
